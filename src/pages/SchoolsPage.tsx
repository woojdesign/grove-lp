...
export function SchoolsPage() {
  ...
  return (
    <>
      ...
      {/* Navigation - Hidden for now (direct landing page links) */}
      {/* <Navigation /> */}
      ...
      <div className="min-h-screen bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-20 max-w-6xl">
            <div className="text-center space-y-12 py-24">
              ...
              >
                ...
                <span className="italic text-accent-color animate-unblur" style={{ animationDelay: '1.2s' }}>{content.hero.headline.highlight}</span>
        ...
        {/* Social Proof Strip - Hidden for now */}
        ...
        <section className="bg-primary text-primary-foreground">
          <div className="grid md:grid-cols-2">
            <div className="relative min-h-[500px] md:min-h-[700px] overflow-hidden">
              <motion.img
        ...
        <section className="py-32 md:py-40 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
            ...
            >
              <HeadingWithEmphasis
                content={content.process.heading}
                as="h2"
                className="font-display text-section-heading-alt font-light"
        ...
        <section className="py-32 md:py-40 bg-primary text-primary-foreground">
          <div className="container mx-auto px-6 md:px-12 max-w-6xl">
            ...
            >
              <HeadingWithEmphasis
                content={content.outcomes.heading}
                as="h2"
                className="font-display text-section-heading-alt font-light"
                animateContainer={false}
              />
        ...
        <section className="py-32 md:py-40 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 md:px-12 max-w-4xl">
            ...
            >
              <HeadingWithEmphasis
                content={content.finalCTA.heading}
                as="h2"
                className="font-display text-section-heading font-light"
                animateContainer={false}
              />
